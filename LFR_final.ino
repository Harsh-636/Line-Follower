...
{    
   ...
   Serial.println(error);
    ...
    if(value == 255 || a[0] && a[7] || (a[2] && a[3] && a[4] && a[5] ))
    {
        do
     {
       sensor_reading();
...
//        right();
    ...
    else if(a[0] == 1 && a[6] == 0 && a[7] == 0 )//delay needs to be used for forward
    {
     do
     {
       sensor_reading();
